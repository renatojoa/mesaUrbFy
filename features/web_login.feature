...
#      Then Eu valido que minha camera foi cadastrada com sucesso
#      Examples: login
#        | email               | senha      | nCondominio                   | nCamera           | nCameraAddress                                                                     | nCameraLogin      | nCameraPassword   |
#        | jao@email.com       | abacate    | CASA DO ITALO DO EGITO        | Acesso Galpão     | rtsp://cameras.nuvemverifybrasil.com.br:554/cam/realmonitor?channel=13&subtype=1   | urbfy             | urbfy             |
#
#
...
#        #| jao@email.com      | oipopo     |
    ...
    Scenario Outline: Criar Condominio com sucesso
      ...
      Examples: login
        ...
        | renatojoa@gmail.com | oipopo     | Piedade Life       | Acesso Galpão     | Condomínio Residencial   | Rua Amabai, 246     | 7 dias          | C:\Users\Renato\Desktop\build.jpg   |